...
$consultation_sql = "SELECT consultations.consultation_number, consulations.date, physicians.employee_name FROM consultations, physicians WHERE fk_consultation_patient_id = '$original_patient_id' AND consultations.fk_consultation_physician_id = physicians.physician_id";
