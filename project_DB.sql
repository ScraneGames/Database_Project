...
SELECT fk_owner_name, owners.shares, ROUND(100.0 * SUM(owners.shares)/owners.shares)
FROM owners
...
USE `Project_DB`;
CREATE  OR REPLACE VIEW view_surgeries (surgery_id, operating_theater, date, time, surgery_type, category, surgeon, surgeon_id, first_nurse, first_nurse_id, second_nurse, second_nurse_id, patient_name, patient_id) AS
SELECT surgery_schedule.surgery_id, surgery_schedule.operating_theater, surgery_schedule.date, surgery_schedule.time, surgery_types.type_name, surgery_types.category, surgeries_by_surgeons.surgeon, surgeries_by_surgeons.surgeon_id, 
surgeries_by_nurse1.nurse1, surgeries_by_nurse1.nurse1_id, surgeries_by_nurse2.nurse2, surgeries_by_nurse2.nurse2_id, surgeries_by_patient.patient_name, surgery_schedule.patient_id
FROM surgery_schedule
JOIN surgeries_by_surgeons
ON surgery_schedule.surgery_id = surgeries_by_surgeons.surgery_id
JOIN surgeries_by_nurse1
ON surgery_schedule.surgery_id = surgeries_by_nurse1.surgery_id
JOIN surgeries_by_nurse2
ON surgery_schedule.surgery_id = surgeries_by_nurse2.surgery_id
...
-- -----------------------------------------------------
-- View `Project_DB`.`surgeries_by_nurse1`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `Project_DB`.`surgeries_by_nurse1` ;
USE `Project_DB`;
CREATE  OR REPLACE VIEW surgeries_by_nurse1 (nurse1, nurse1_id, surgery_id) AS
SELECT staff.employee_name, surgery_schedule.fk_nurse_id_1, surgery_schedule.surgery_id 
FROM staff 
JOIN nurses 
...
-- -----------------------------------------------------
-- View `Project_DB`.`surgeries_by_nurse2`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `Project_DB`.`surgeries_by_nurse2` ;
USE `Project_DB`;
CREATE  OR REPLACE VIEW surgeries_by_nurse2 (nurse2, nurse2_id, surgery_id) AS
SELECT staff.employee_name, surgery_schedule.fk_nurse_id_2, surgery_schedule.surgery_id 
FROM staff 
JOIN nurses 
ON staff.employee_id = nurses.employee_id 
JOIN surgery_schedule 
