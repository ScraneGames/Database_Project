...
USE `Project_DB`;
CREATE  OR REPLACE VIEW view_surgeries (surgery_id, operating_theater, date, surgery_type, category, surgeon, first_nurse, second_nurse, patient_name, patient_id) AS
SELECT surgery_schedule.surgery_id, surgery_schedule.operating_theater, surgery_schedule.date, surgery_types.type_name, surgery_types.category, surgeries_by_surgeon.surgeon, surgeries_by_nurse1.nurse1, surgeries_by_nurse2.nurse2, surgeries_by_patient.patient_name, surgery_schedule.patient_id
