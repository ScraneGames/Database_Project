...
USE `Project_DB`;
CREATE  OR REPLACE VIEW view_surgeries (operating_theater, date, surgery_type, category, surgeon, first_nurse, second_nurse, patient_name, patient_id) AS
SELECT surgery_schedule.operating_theater, surgery_schedule.date, surgery_types.type_name, surgery_types.category, 
